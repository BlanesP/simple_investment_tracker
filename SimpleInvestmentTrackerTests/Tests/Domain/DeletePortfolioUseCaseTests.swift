//
//  DeletePortfolioUseCaseTests.swift
...
class DeletePortfolioUseCaseTests: XCTestCase {

    private var cancellables = Set<AnyCancellable>()
    private let repository = PortfolioRepositoryMock()
    private lazy var useCase = DefaultDeletePortfolioUseCase(repository: repository)
